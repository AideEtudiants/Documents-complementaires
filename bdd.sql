--------------------------------------------------------
--  Fichier créé - mardi-décembre-14-2021   
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Table CART
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."CART" 
   (	"ID_CART" NUMBER(*,0) GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 1000000 INCREMENT BY 1 START WITH 1 CACHE 100000 ORDER  CYCLE  NOKEEP  NOSCALE , 
	"ID_USER" NUMBER(*,0), 
	"ID_PRODUCT" NUMBER(*,0), 
	"QUANTITY" NUMBER
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."USERS" 
   (	"FIRST_NAME" VARCHAR2(20 BYTE), 
	...
	"ID_USER" NUMBER(*,0) GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 1000000 INCREMENT BY 1 START WITH 1 CACHE 10000 ORDER  CYCLE  NOKEEP  NOSCALE 
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
SET DEFINE OFF;
Insert into SYSTEM.CART (ID_CART,ID_USER,ID_PRODUCT,QUANTITY) values ('18','7','10219',null);
Insert into SYSTEM.CART (ID_CART,ID_USER,ID_PRODUCT,QUANTITY) values ('14','9','10218',null);
Insert into SYSTEM.CART (ID_CART,ID_USER,ID_PRODUCT,QUANTITY) values ('19','9','10218',null);
Insert into SYSTEM.CART (ID_CART,ID_USER,ID_PRODUCT,QUANTITY) values ('20','9','10218',null);
Insert into SYSTEM.CART (ID_CART,ID_USER,ID_PRODUCT,QUANTITY) values ('17','9','10218',null);
Insert into SYSTEM.CART (ID_CART,ID_USER,ID_PRODUCT,QUANTITY) values ('21','7','10219',null);
Insert into SYSTEM.CART (ID_CART,ID_USER,ID_PRODUCT,QUANTITY) values ('22','5','115',null);
...
SET DEFINE OFF;
Insert into SYSTEM.PRODUCT (NAME,IMAGE,DESCRIPTION,ID_STATUS,ID_CATEGORY,ID_USER,ID_PRODUCT,ID_AVAILABILITY,PRICE,QUANTITY) values ('ordinateur','ordi','ordi','1','1','9','10218','3','1000','1');
Insert into SYSTEM.PRODUCT (NAME,IMAGE,DESCRIPTION,ID_STATUS,ID_CATEGORY,ID_USER,ID_PRODUCT,ID_AVAILABILITY,PRICE,QUANTITY) values ('TestFonction','TestFonction','TestFonction','1','2','4','220','1','200','3');
Insert into SYSTEM.PRODUCT (NAME,IMAGE,DESCRIPTION,ID_STATUS,ID_CATEGORY,ID_USER,ID_PRODUCT,ID_AVAILABILITY,PRICE,QUANTITY) values ('Update','Update','Update','1','2','4','221','1','200','2');
Insert into SYSTEM.PRODUCT (NAME,IMAGE,DESCRIPTION,ID_STATUS,ID_CATEGORY,ID_USER,ID_PRODUCT,ID_AVAILABILITY,PRICE,QUANTITY) values ('ecran','ecran','ecran','1','1','7','10219','1','100','1');
Insert into SYSTEM.PRODUCT (NAME,IMAGE,DESCRIPTION,ID_STATUS,ID_CATEGORY,ID_USER,ID_PRODUCT,ID_AVAILABILITY,PRICE,QUANTITY) values ('livre','abc','abc','1','1','5','115','3','100','0');
Insert into SYSTEM.PRODUCT (NAME,IMAGE,DESCRIPTION,ID_STATUS,ID_CATEGORY,ID_USER,ID_PRODUCT,ID_AVAILABILITY,PRICE,QUANTITY) values ('abc','e','e','1','1','5','116','1','100','2');
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CLASS" MODIFY ("DATE" NOT NULL ENABLE);
