...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."CART" 
   (	"ID_CART" NUMBER(*,0) GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 1000000 INCREMENT BY 1 START WITH 1 CACHE 10000 ORDER  CYCLE  NOKEEP  NOSCALE , 
	"ID_USER" NUMBER(*,0), 
	"ID_PRODUCT" NUMBER(*,0)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
...
SET DEFINE OFF;
Insert into SYSTEM.CART (ID_CART,ID_USER,ID_PRODUCT) values ('13','4','220');
Insert into SYSTEM.CART (ID_CART,ID_USER,ID_PRODUCT) values ('14','9','10218');
...
Insert into SYSTEM.PRODUCT (NAME,IMAGE,DESCRIPTION,ID_STATUS,ID_CATEGORY,ID_USER,ID_PRODUCT,ID_AVAILABILITY,PRICE,QUANTITY) values ('TestFonction','TestFonction','TestFonction','1','2','4','220','3','200','1');
...
Insert into SYSTEM.PRODUCT (NAME,IMAGE,DESCRIPTION,ID_STATUS,ID_CATEGORY,ID_USER,ID_PRODUCT,ID_AVAILABILITY,PRICE,QUANTITY) values ('ecran','ecran','ecran','1','1','7','10219','1','100','3');
Insert into SYSTEM.PRODUCT (NAME,IMAGE,DESCRIPTION,ID_STATUS,ID_CATEGORY,ID_USER,ID_PRODUCT,ID_AVAILABILITY,PRICE,QUANTITY) values ('livre','abc','abc','1','1','5','115','2','100','1');
